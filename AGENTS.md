...
- **Project Guidelines:** This file (`AGENTS.md`)
...
| Date       | Update                           | By                              |
| ---------- | -------------------------------- | ------------------------------- |
| 2025-11-03 | Initial AGENTS.md creation       | Codex Documentation Agent |
| 2025-11-03 | Added AI documentation structure | Codex Documentation Agent |
